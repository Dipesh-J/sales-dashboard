...
const ActiveStoresByBrandChart = ({ data, title, isLoading, error, onBarClick, sortable, sortOrder, onSortChange }) => {
...
export default ActiveStoresByBrandChart;
